...
class TS2Vec:
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False):
        ...
        if self.max_train_length is not None:
            ...
            if sections >= 2:
                train_data = np.concatenate(split_with_nan(
                    train_data, sections, axis=1), axis=0)
        ...
        while True:
            ...
            for batch in train_loader:
                ...
                out1 = self._net(take_per_row(
                    x, crop_offset + crop_eleft, crop_right - crop_eleft))
                out1 = out1[:, -crop_l:]

                out2 = self._net(take_per_row(
    ...
    def load(self, fn):
        ...
        state_dict = torch.load(
            fn, map_location=self.device, weights_only=True)
